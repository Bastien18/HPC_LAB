...
* Date : 4.3.2024
* Description : Give user functions to :
*	- Convert an image to grayscale
*	- Apply Gaussian blur on grayscale image
*	- Apply vertical and horizontal sobel on blurred image to bring out edges
* For both 1D and simple linked list representation
*
*/
